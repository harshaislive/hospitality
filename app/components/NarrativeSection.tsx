      ...
      <section className="py-[120px] px-5 md:px-10 bg-white">
        <div className="max-w-[1000px] mx-auto text-center mb-[60px]">
            ...
            <p className="text-[1.1rem] leading-[1.8] font-light max-w-[800px] mx-auto">
                The Poomaale Collective, a 300+ acre landscape, nestled in the Brahmagiri foothills encompasses three hillocks and three perennial streams.
            </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1200px] mx-auto mb-[60px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-[1000px] mx-auto text-center px-4">
            <div>
                <h3 className="font-serif text-[1.5rem] mb-3 text-dark-earth">Impact Unveiled</h3>
                <p className="text-[0.9rem] leading-[1.6] text-dark-brown">
